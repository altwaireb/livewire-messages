...
class Conversation extends Model
{
    ...
    {
        return [
            'sender_favorite' => 'boolean',
            'receiver_favorite' => 'boolean',
        ];
    }
    ...
    public function allUnreadMessagesCount(): int
    {
        return $unreadMessages = Message::where('receiver_id', auth()->user()->id)
            ->whereNull('read_at')->count();
    }
